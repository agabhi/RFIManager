...
function edit()
{
	if(isEmpty(document.getElementById("status_edit").value))
	{
		alert("Select a Status!");
		return false;
	}
	
	if(isEmpty(document.getElementById("statusNew_edit").value))
	{
...
<table id="container" style="width:100%;" cellspacing="0" cellpadding="0">
	<tr width:100%">
		<td valign="top" style="border-bottom:1 px solid gray;padding-right:5;padding-bottom:10">
					...
					<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="4">
						<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
							<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
			        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Add Status</label>
			        		</td></tr>
			        	</table>
				...
				<tr>
					<td>
						<form:form id="statusForm" method="POST" commandName="status" cssStyle="margin: 0px; padding: 0px;">
							<form:errors path="*" />
							<input type="hidden" id="actionType" name="actionType" value="add">
							<table>
								<tr>
									<td>
										<label><font size="4">Status</font></label>
									</td>
									<td style="border:0">
		...
		<td valign="top" style="border-bottom:1 px solid gray;padding-right:5;padding-bottom:10">
				...
				<tr>
					<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="4">
						<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
							<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
			        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Delete Status</label>
			        		</td></tr>
			        	</table>
						...
						<form:form id="statusForm" method="POST" commandName="status" cssStyle="margin: 0px; padding: 0px;">
							...
							<table>
								...
								<tr>
									...
									<td style="border:0">
										<form:select id="status_edit" path="status"> 
							...
							<!-- 
								<tr>
									...
									<td style="border:0">
										<form:input id="statusNew_edit" path="newStatus" />
									</td>
								</tr>
							 -->	
								<tr>
									<td colspan="2">
										...
										<input id="submitButton" type="submit" value="Delete" onClick="return deleteStatus()">
									</td>
		...
		<table border="1" class="curvedEdges" style="text-align:center;width:100%;" cellspacing="0" cellpadding="5"  > 
			<tr>
				<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="6">
					<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
						<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
		        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Status List</label>
		        		</td></tr>
		        	</table>
