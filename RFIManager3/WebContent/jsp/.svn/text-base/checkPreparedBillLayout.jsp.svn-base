...
function exportBill()
{
		var url = '/RFIManager3/exportPreparedBill.htm';
		window.location = url;
  		return false;
}
...
<form:form id="finalizeBillForm" method="POST" commandName="finalizeBill" cssStyle="margin: 0px; padding: 0px;" action="/RFIManager3/finalizePreparedBill.htm">
	<form:errors path="*" />
...
<a href="/RFIManager3/intermediateCalculationSheet.htm">View Calculation sheet</a>&nbsp;
<a href="/RFIManager3/intermediateDeductionSheet.htm">View Deduction sheet</a>
