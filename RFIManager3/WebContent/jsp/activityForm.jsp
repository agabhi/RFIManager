...
function edit()
{
	...
	if(isEmpty(document.getElementById("activityNew_edit").value))
	{
		alert("New Activity cannot be blank!");
		return false;
	}
...
<table id="container" style="width:100%;" cellspacing="0" cellpadding="0">
	<tr width:100%">
		<td valign="top" style="border-bottom:1 px solid gray;padding-right:5;padding-bottom:10">
					...
					<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="4">
						<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
							<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
			        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Add Activity</label>
			        		</td></tr>
			        	</table>
				...
				<tr>
					<td>
						<form:form id="activityForm" method="POST" commandName="activity" cssStyle="margin: 0px; padding: 0px;">
							<form:errors path="*" />
		...
		<td valign="top" style="border-bottom:1 px solid gray;padding-right:5;padding-bottom:10">
				...
				<tr>
					<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="4">
						<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
							<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
			        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Delete Activity</label>
			        		</td></tr>
			        	</table>
						...
						<form:form id="activityForm" method="POST" commandName="activity" cssStyle="margin: 0px; padding: 0px;">
							...
							<table>
								...
								<tr>
									...
									<td style="border:0">
										<form:select id="activity_edit" path="activity"> 
								...
								<tr>
									...
									<td style="border:0">
										<form:input id="activityNew_edit" path="newActivity" />
									</td>
								</tr>
								-->
								<tr>
									<td colspan="2">
										...
										<input id="submitButton" type="submit" value="Delete" onClick="return deleteActivity()">
									</td>
		...
		<table border="1" class="curvedEdges" style="text-align:center;width:100%;" cellspacing="0" cellpadding="5"  > 
			<tr>
				<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="6">
					<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
						<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
		        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Activity List</label>
		        		</td></tr>
		        	</table>
