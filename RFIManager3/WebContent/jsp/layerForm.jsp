...
function add()
{
	...
	{
		alert("Layer cannot be blank!");
		return false;
	}
	
	if(!isInteger(document.getElementById("layer").value.charAt(0)))
	{
		alert("Layer should start with a number!");
		return false;
	}
...
function edit()
{
	...
	if(isEmpty(document.getElementById("layerNew_edit").value))
	{
		alert("New Layer cannot be blank!");
		return false;
	}
...
/*	
	if(!isInteger(document.getElementById("layer_edit").value))
	{
		alert("Layer should be a non-negative integer value!");
		return false;
	}
*/	
...
<table id="container" style="width:100%;" cellspacing="0" cellpadding="0">
	<tr width:100%">
		<td valign="top" style="border-bottom:1 px solid gray;padding-right:5;padding-bottom:10">
				...
				<tr>
					<td>
						<form:form id="layerForm" method="POST" commandName="layer" cssStyle="margin: 0px; padding: 0px;">
							<form:errors path="*" />
							...
							<table>
								<tr>
									...
									<td style="border:0">
										<form:input id="layer" path="layer" /> 
									</td>
								</tr>
		...
		<td valign="top" style="border-bottom:1 px solid gray;padding-right:5;padding-bottom:10">
				...
				<tr>
					<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="4">
						<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
							<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
			        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Delete Layer</label>
			        		</td></tr>
			        	</table>
						...
						<form:form id="layerForm" method="POST" commandName="layer" cssStyle="margin: 0px; padding: 0px;">
							...
							<table>
								...
								<tr>
									...
									<td style="border:0">
										<form:input id="layerNew_edit" path="newLayer" />
									</td>
								</tr>
								-->
								<tr>
									<td colspan="2">
										...
										<input id="submitButton" type="submit" value="Delete" onClick="return deleteLayer()">
									</td>
		...
		<table border="1" class="curvedEdges" style="text-align:center;width:100%;" cellspacing="0" cellpadding="5"  > 
			<tr>
				<td style="border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="6">
					<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
						<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
		        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Layer List</label>
		        		</td></tr>
		        	</table>
