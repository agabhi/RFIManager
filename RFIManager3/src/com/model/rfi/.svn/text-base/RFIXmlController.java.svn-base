...
public class RFIXmlController extends AbstractController
{
	...
	static
	{
		...
		columnTypeMap.put("quantity","numeric");
		columnTypeMap.put("bill_number","string");
		columnTypeMap.put("remarks","string");
			 										...
			 										HttpServletResponse response) throws Exception
	{
		 ...
		 {
			 String editSuccess = (String)request.getAttribute("editSuccess");
	 ...
	 public void write(WritableWorkbook workbook, List<ExpandedRFI>expandedRFIList) throws IOException, WriteException {
		...
		private void createLabel(WritableSheet sheet)
			...
			addLabel(sheet, 3, 0, "BOQ No.");
			addLabel(sheet, 4, 0, "Item");
			addLabel(sheet, 5, 0, "WI Remarks");
			addLabel(sheet, 6, 0, "From Chainage");
			addLabel(sheet, 7, 0, "To Chainage");
			addLabel(sheet, 8, 0, "Side");
			addLabel(sheet, 9, 0, "Layer");
			addLabel(sheet, 10, 0, "Status");
			addLabel(sheet, 11, 0, "Grade");
			addLabel(sheet, 12, 0, "Inspection date");
			addLabel(sheet, 13, 0, "Created By");
			addLabel(sheet, 14, 0, "Last Updated By");
			addLabel(sheet, 15, 0, "Appr From");
			addLabel(sheet, 16, 0, "Appr To");
			addLabel(sheet, 17, 0, "Appr Side");
			addLabel(sheet, 18, 0, "Appr Layer");
			addLabel(sheet, 19, 0, "Appr Date");
			addLabel(sheet, 20, 0, "Bill Number");
			addLabel(sheet, 21, 0, "Remarks");
		...
		private void createContent(WritableSheet sheet, List<ExpandedRFI> expandedRFIList) throws WriteException,
			...
			while(it.hasNext())
			{
				...
				addString(sheet,3,rowNumber,expandedRFI.getBoqNumber());
				addString(sheet,4,rowNumber,expandedRFI.getItemDescription());
				addString(sheet,5,rowNumber,expandedRFI.getWiRemarks());
				addNumber(sheet,6,rowNumber,expandedRFI.getFromChainage());
				addNumber(sheet,7,rowNumber,expandedRFI.getToChainage());
				addString(sheet,8,rowNumber,expandedRFI.getSide());
				addString(sheet,9,rowNumber,expandedRFI.getLayer());
				addString(sheet,10,rowNumber,expandedRFI.getStatus());
				addString(sheet,11,rowNumber,expandedRFI.getGrade());
				addLongDate(sheet,12,rowNumber,expandedRFI.getInspectionDate());
				addString(sheet,13,rowNumber,expandedRFI.getCreatedByUserName());
				addString(sheet,14,rowNumber,expandedRFI.getLastEditedByUserName());
				addNumber(sheet,15,rowNumber,expandedRFI.getApprovedFrom());
				addNumber(sheet,16,rowNumber,expandedRFI.getApprovedTo());
				addString(sheet,17,rowNumber,expandedRFI.getApprovedSide());
				addString(sheet,18,rowNumber,expandedRFI.getApprovedLayer());
				addDate(sheet,19,rowNumber,expandedRFI.getApprovalDate());
				addString(sheet,20,rowNumber,expandedRFI.getBillNumber());
				addString(sheet,21,rowNumber,expandedRFI.getRemarks());
