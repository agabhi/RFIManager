...
{
		var url = '<%=request.getContextPath()%>/exportDeductionSheet.htm';
		window.location = url;
  		return false;
}
...
<form:form id="finalizeBillForm" method="POST" commandName="finalizeBill" cssStyle="margin: 0px; padding: 0px;">
	<input id="exportCalculationSheetButton" type="button" value="Export Deduction sheet" onclick="exportCalculationSheet();">
</form:form>
