...
function generateBarChart()
{
	...
	var queryString = $('#gapsform').serialize();
	//alert(queryString);
	...
	for(i=0;i<loopCount;++i)
	{
		...
		var url1 ="<%=request.getContextPath()%>/gapsTable.htm?"+queryString;
...
<body>
<form:form id="gapsform" method="POST" commandName="drawStatusBarChart" cssStyle="margin: 0px; padding: 0px;">
					...
					<td style="width:100%;border:0;padding-left:0px;padding-top:0px;padding-bottom:0px;padding-right:0px;" colspan="6">
						<table class="curvedEdges1" style="width:100%;" cellspacing="0" cellpadding="5">
							<tr><td style="background-image:url(css/ui-lightness/images/ui-bg_gloss-wave_35_f6a828_500x100.png); background-repeat: repeat-x;">
			        			<label id="rfiHeader" style="font-family:Comic Sans MS;font-size:medium;color:#FFFFFF;">Gaps</label>
			        		</td></tr>
			        	</table>
