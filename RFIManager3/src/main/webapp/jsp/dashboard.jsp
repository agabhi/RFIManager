...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/jqplot/jquery.jqplot.css" />
	<script src="<%=request.getContextPath()%>/js/jquery-1.5.2.min.js" type="text/javascript"></script>
	<script language="javascript" type="text/javascript" src="<%=request.getContextPath()%>/jqplot/jquery.jqplot.min.js"></script>
<script class="include" language="javascript" type="text/javascript" src="<%=request.getContextPath()%>/jqplot/plugins/jqplot.pieRenderer.js"></script>
  
  
<script class="code" type="text/javascript">
$(document).ready(function(){
	
	$.post("<%=request.getContextPath()%>/pieChartStatus.htm",
			  {pieChart: 'allStatus'},
			  function(array){
				  var i;
				  var data1 = new Array();
